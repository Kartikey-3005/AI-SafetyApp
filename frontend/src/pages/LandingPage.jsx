  ...
  return (
    <div className="space-y-16 py-8">
      ...
      <section className="text-center space-y-6 max-w-3xl mx-auto pt-6">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-[#2A1638] border border-[#4A2A5E] text-[#F6DBC0] text-xs font-mono font-bold tracking-widest uppercase">
          <Shield className="w-3.5 h-3.5 text-[#F6DBC0]" /> Next-Generation Child Safety
        </div>

        <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-[#F8F4E9] uppercase leading-none">
          Neural Defense <br />
          <span className="text-[#F6DBC0]">
            For Young Minds
          </span>
        </h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="hud-card p-6 space-y-3">
          <div className="w-10 h-10 bg-[#1A0E23] border border-[#F6DBC0] flex items-center justify-center text-[#F6DBC0]">
        ...
        <div className="hud-card p-6 space-y-3">
          <div className="w-10 h-10 bg-[#1A0E23] border border-[#935073] flex items-center justify-center text-[#F6DBC0]">
            <HeartHandshake className="w-5 h-5 text-[#F6DBC0]" />
          </div>
